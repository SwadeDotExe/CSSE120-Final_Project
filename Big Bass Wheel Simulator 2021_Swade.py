...
def fade_in(object1, object2, speed, offset):
    if object2 is None:
        for a in range(255):
            object1.set_alpha(a)
            screen.blit(object1, (((screen.get_width() // 2) - object1.get_width() // 2), (screen.get_height() // 2) - offset))
    ...
    while True:
            ...
            while GameState == "menu":
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.MOUSEBUTTONUP:
                        ...
                        # Play Button
                        if mouse_position[0] >= 555 and mouse_position[0] <= 650 and mouse_position[1] >= 270 and mouse_position[1] <= 305:
                            GameState = "play"
                            break

                        # Help Button
                        if mouse_position[0] >= 555 and mouse_position[0] <= 650 and mouse_position[1] >= 345 and mouse_position[1] <= 380:
                            GameState = "help"
                            ...
                            screen.blit(help_text_render, (((screen.get_width() // 2) - help_text_render.get_width() // 2), (screen.get_height() // 2) - 200))
                            ...
                            screen.blit(help_text1_render, (((screen.get_width() // 2) - help_text1_render.get_width() // 2), (screen.get_height() // 2) - 150))
                            ...
                            screen.blit(help_text2_render, (((screen.get_width() // 2) - help_text2_render.get_width() // 2), (screen.get_height() // 2) - 85))
                            ...
                            screen.blit(help_text3_render, (((screen.get_width() // 2) - help_text3_render.get_width() // 2), (screen.get_height() // 2) - 65))
                            ...
                            screen.blit(help_text4_render, (((screen.get_width() // 2) - help_text4_render.get_width() // 2), (screen.get_height() // 2) - 45))
                            ...
                            screen.blit(help_text5_render, (((screen.get_width() // 2) - help_text5_render.get_width() // 2), (screen.get_height() // 2) - 25))
                            ...
                            screen.blit(help_text6_render, (((screen.get_width() // 2) - help_text6_render.get_width() // 2), (screen.get_height() // 2) - 5))
                            ...
                            screen.blit(help_text7_render, (((screen.get_width() // 2) - help_text7_render.get_width() // 2), (screen.get_height() // 2) + 15))
                            ...
                            screen.blit(help_text8_render, (((screen.get_width() // 2) - help_text8_render.get_width() // 2), (screen.get_height() // 2) + 35))
                            ...
                            screen.blit(help_text9_render, (((screen.get_width() // 2) - help_text9_render.get_width() // 2), (screen.get_height() // 2) + 55))
                            ...
                            screen.blit(help_text10_render, (((screen.get_width() // 2) - help_text10_render.get_width() // 2), (screen.get_height() // 2) + 200))
                            ...
                            menu_back_box = pygame.Surface((menu_back_render.get_width() * 1.5, menu_back_render.get_height() * 1.5))
                            ...
                            while GameState == "help":
                                for event in pygame.event.get():
                                    ...
                                    if event.type == pygame.MOUSEBUTTONUP:
                                        ...
                                        if mouse_position[0] >= 550 and mouse_position[0] <= 650 and mouse_position[1] >= 500 and mouse_position[1] <= 530:
                                            GameState = "play"
                                            break

                        # Quit Button
                        if mouse_position[0] >= 555 and mouse_position[0] <= 650 and mouse_position[1] >= 425 and mouse_position[1] <= 455:
                            pygame.quit()
                            sys.exit()
        ...
        while GameState == "play":
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    sys.exit()
                if event.type == pygame.KEYUP and pressed[pygame.K_UP]:
                    WheelState = "spin"
                    score.score -= 10
                    coin_sound.play(0)
                if event.type == pygame.MOUSEBUTTONUP:
